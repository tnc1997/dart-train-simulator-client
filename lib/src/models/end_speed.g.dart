...
part of 'end_speed.dart';

// **************************************************************************
// XmlSerializableGenerator
// **************************************************************************

void _$EndSpeedBuildXmlChildren(EndSpeed instance, XmlBuilder builder,
...
void _$EndSpeedBuildXmlElement(EndSpeed instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('EndSpeed', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

EndSpeed _$EndSpeedFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$EndSpeedToXmlAttributes(EndSpeed instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$EndSpeedToXmlChildren(EndSpeed instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$EndSpeedToXmlElement(EndSpeed instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('EndSpeed'),
      [
