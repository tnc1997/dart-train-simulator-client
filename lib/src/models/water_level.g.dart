...
void _$WaterLevelBuildXmlChildren(WaterLevel instance, XmlBuilder builder,
...
void _$WaterLevelBuildXmlElement(WaterLevel instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('WaterLevel', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

WaterLevel _$WaterLevelFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$WaterLevelToXmlAttributes(WaterLevel instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$WaterLevelToXmlChildren(WaterLevel instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$WaterLevelToXmlElement(WaterLevel instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('WaterLevel'),
      [
