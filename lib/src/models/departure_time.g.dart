...
void _$DepartureTimeBuildXmlChildren(DepartureTime instance, XmlBuilder builder,
...
void _$DepartureTimeBuildXmlElement(DepartureTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('DepartureTime', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

DepartureTime _$DepartureTimeFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$DepartureTimeToXmlAttributes(DepartureTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$DepartureTimeToXmlChildren(DepartureTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$DepartureTimeToXmlElement(DepartureTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
