...
void _$CTenderBuildXmlChildren(CTender instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  final coalLevel = instance.coalLevel;
  final coalLevelSerialized = coalLevel;
  if (coalLevelSerialized != null) {
    builder.element('CoalLevel', isSelfClosing: false, nest: () {
      coalLevelSerialized.buildXmlChildren(builder, namespaces: namespaces);
    });
  }
  ...
  final waterLevelSerialized = waterLevel;
  if (waterLevelSerialized != null) {
    builder.element('WaterLevel', isSelfClosing: false, nest: () {
      waterLevelSerialized.buildXmlChildren(builder, namespaces: namespaces);
    });
  }
}

void _$CTenderBuildXmlElement(CTender instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('cTender', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
CTender _$CTenderFromXmlElement(XmlElement element) {
  final coalLevel = element.getElement('CoalLevel');
  ...
  final waterLevel = element.getElement('WaterLevel');
  return CTender(
...
List<XmlAttribute> _$CTenderToXmlAttributes(CTender instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$CTenderToXmlChildren(CTender instance,
    {Map<String, String?> namespaces = const {}}) {
  final children = <XmlNode>[];
  final coalLevel = instance.coalLevel;
  final coalLevelSerialized = coalLevel;
  final coalLevelConstructed = coalLevelSerialized != null
      ? XmlElement(
          XmlName('CoalLevel'),
          coalLevelSerialized.toXmlAttributes(namespaces: namespaces),
          coalLevelSerialized.toXmlChildren(namespaces: namespaces),
          false)
      : null;
  if (coalLevelConstructed != null) {
    children.add(coalLevelConstructed);
  }
  final flipped = instance.flipped;
  final flippedSerialized = flipped;
  ...
  final waterLevel = instance.waterLevel;
  final waterLevelSerialized = waterLevel;
  final waterLevelConstructed = waterLevelSerialized != null
      ? XmlElement(
          XmlName('WaterLevel'),
          waterLevelSerialized.toXmlAttributes(namespaces: namespaces),
          waterLevelSerialized.toXmlChildren(namespaces: namespaces),
          false)
      : null;
  if (waterLevelConstructed != null) {
    children.add(waterLevelConstructed);
  }
  return children;
}

XmlElement _$CTenderToXmlElement(CTender instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('cTender'),
      [
