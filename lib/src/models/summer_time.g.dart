...
void _$SummerTimeBuildXmlChildren(SummerTime instance, XmlBuilder builder,
...
void _$SummerTimeBuildXmlElement(SummerTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('SummerTime', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$SummerTimeToXmlAttributes(SummerTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$SummerTimeToXmlChildren(SummerTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$SummerTimeToXmlElement(SummerTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('SummerTime'),
      [
