...
void _$EBuildXmlChildren(E instance, XmlBuilder builder,
...
void _$EBuildXmlElement(E instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('e', namespaces: namespaces, isSelfClosing: false, nest: () {
...
List<XmlAttribute> _$EToXmlAttributes(E instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$EToXmlChildren(E instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$EToXmlElement(E instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('e'),
      [
