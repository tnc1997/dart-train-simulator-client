...
void _$AwsTimerBuildXmlChildren(AwsTimer instance, XmlBuilder builder,
...
void _$AwsTimerBuildXmlElement(AwsTimer instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('AWSTimer', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$AwsTimerToXmlAttributes(AwsTimer instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$AwsTimerToXmlChildren(AwsTimer instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$AwsTimerToXmlElement(AwsTimer instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('AWSTimer'),
      [
