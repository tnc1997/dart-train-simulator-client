...
void _$HeightBuildXmlChildren(Height instance, XmlBuilder builder,
...
void _$HeightBuildXmlElement(Height instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('Height', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$HeightToXmlAttributes(Height instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$HeightToXmlChildren(Height instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$HeightToXmlElement(Height instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('Height'),
      [
