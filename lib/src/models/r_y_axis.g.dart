...
void _$RYAxisBuildXmlChildren(RYAxis instance, XmlBuilder builder,
...
void _$RYAxisBuildXmlElement(RYAxis instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('RYAxis', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$RYAxisToXmlAttributes(RYAxis instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$RYAxisToXmlChildren(RYAxis instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$RYAxisToXmlElement(RYAxis instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('RYAxis'),
      [
