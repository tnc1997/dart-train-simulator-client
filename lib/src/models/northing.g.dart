...
void _$NorthingBuildXmlChildren(Northing instance, XmlBuilder builder,
...
void _$NorthingBuildXmlElement(Northing instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('Northing', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$NorthingToXmlAttributes(Northing instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$NorthingToXmlChildren(Northing instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$NorthingToXmlElement(Northing instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('Northing'),
      [
