...
void _$TpwsDistanceBuildXmlChildren(TpwsDistance instance, XmlBuilder builder,
...
void _$TpwsDistanceBuildXmlElement(TpwsDistance instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('TPWSDistance', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$TpwsDistanceToXmlAttributes(TpwsDistance instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$TpwsDistanceToXmlChildren(TpwsDistance instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$TpwsDistanceToXmlElement(TpwsDistance instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
