...
part of 'ticked_time.dart';

// **************************************************************************
// XmlSerializableGenerator
// **************************************************************************

void _$TickedTimeBuildXmlChildren(TickedTime instance, XmlBuilder builder,
...
void _$TickedTimeBuildXmlElement(TickedTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('TickedTime', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

TickedTime _$TickedTimeFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$TickedTimeToXmlAttributes(TickedTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$TickedTimeToXmlChildren(TickedTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$TickedTimeToXmlElement(TickedTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('TickedTime'),
      [
