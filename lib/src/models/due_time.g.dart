...
void _$DueTimeBuildXmlChildren(DueTime instance, XmlBuilder builder,
...
void _$DueTimeBuildXmlElement(DueTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('DueTime', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$DueTimeToXmlAttributes(DueTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$DueTimeToXmlChildren(DueTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$DueTimeToXmlElement(DueTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('DueTime'),
      [
