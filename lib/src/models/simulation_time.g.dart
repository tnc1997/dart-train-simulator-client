...
void _$SimulationTimeBuildXmlChildren(
    SimulationTime instance, XmlBuilder builder,
...
void _$SimulationTimeBuildXmlElement(
    SimulationTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('SimulationTime',
...
List<XmlAttribute> _$SimulationTimeToXmlAttributes(SimulationTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$SimulationTimeToXmlChildren(SimulationTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$SimulationTimeToXmlElement(SimulationTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
