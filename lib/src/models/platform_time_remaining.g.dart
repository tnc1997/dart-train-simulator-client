...
void _$PlatformTimeRemainingBuildXmlChildren(
    PlatformTimeRemaining instance, XmlBuilder builder,
...
void _$PlatformTimeRemainingBuildXmlElement(
    PlatformTimeRemaining instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('PlatformTimeRemaining',
...
XmlElement _$PlatformTimeRemainingToXmlElement(PlatformTimeRemaining instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
