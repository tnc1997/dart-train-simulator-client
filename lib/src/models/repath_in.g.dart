...
void _$RepathInBuildXmlChildren(RepathIn instance, XmlBuilder builder,
...
void _$RepathInBuildXmlElement(RepathIn instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('RepathIn', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$RepathInToXmlAttributes(RepathIn instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$RepathInToXmlChildren(RepathIn instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$RepathInToXmlElement(RepathIn instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('RepathIn'),
      [
