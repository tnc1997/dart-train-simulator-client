...
void _$DurationSecsBuildXmlChildren(DurationSecs instance, XmlBuilder builder,
...
void _$DurationSecsBuildXmlElement(DurationSecs instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('DurationSecs', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$DurationSecsToXmlAttributes(DurationSecs instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$DurationSecsToXmlChildren(DurationSecs instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$DurationSecsToXmlElement(DurationSecs instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
