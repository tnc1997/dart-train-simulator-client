...
void _$ActivationLevelBuildXmlChildren(
    ActivationLevel instance, XmlBuilder builder,
...
void _$ActivationLevelBuildXmlElement(
    ActivationLevel instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('ActivationLevel',
...
ActivationLevel _$ActivationLevelFromXmlElement(XmlElement element) {
  ...
  final type = element.getAttribute('type',
      namespace: 'http://www.kuju.com/TnT/2003/Delta');
  return ActivationLevel(text: text, type: type);
}

List<XmlAttribute> _$ActivationLevelToXmlAttributes(ActivationLevel instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$ActivationLevelToXmlChildren(ActivationLevel instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$ActivationLevelToXmlElement(ActivationLevel instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
