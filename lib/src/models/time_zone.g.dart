...
void _$TimeZoneBuildXmlChildren(TimeZone instance, XmlBuilder builder,
...
void _$TimeZoneBuildXmlElement(TimeZone instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('TimeZone', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$TimeZoneToXmlAttributes(TimeZone instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$TimeZoneToXmlChildren(TimeZone instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$TimeZoneToXmlElement(TimeZone instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('TimeZone'),
      [
