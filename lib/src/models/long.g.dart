...
void _$LongBuildXmlChildren(Long instance, XmlBuilder builder,
...
void _$LongBuildXmlElement(Long instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('Long', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$LongToXmlAttributes(Long instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$LongToXmlChildren(Long instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$LongToXmlElement(Long instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('Long'),
      [
