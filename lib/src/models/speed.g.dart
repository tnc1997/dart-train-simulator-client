...
void _$SpeedBuildXmlChildren(Speed instance, XmlBuilder builder,
...
void _$SpeedBuildXmlElement(Speed instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('Speed', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

Speed _$SpeedFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$SpeedToXmlAttributes(Speed instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$SpeedToXmlChildren(Speed instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$SpeedToXmlElement(Speed instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('Speed'),
      [
