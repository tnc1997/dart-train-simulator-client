...
part of 'arrival_time.dart';

// **************************************************************************
// XmlSerializableGenerator
// **************************************************************************

void _$ArrivalTimeBuildXmlChildren(ArrivalTime instance, XmlBuilder builder,
...
void _$ArrivalTimeBuildXmlElement(ArrivalTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('ArrivalTime', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

ArrivalTime _$ArrivalTimeFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$ArrivalTimeToXmlAttributes(ArrivalTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$ArrivalTimeToXmlChildren(ArrivalTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$ArrivalTimeToXmlElement(ArrivalTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('ArrivalTime'),
      [
