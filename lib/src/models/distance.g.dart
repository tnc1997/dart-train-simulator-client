...
void _$DistanceBuildXmlChildren(Distance instance, XmlBuilder builder,
...
void _$DistanceBuildXmlElement(Distance instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('Distance', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

Distance _$DistanceFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$DistanceToXmlAttributes(Distance instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$DistanceToXmlChildren(Distance instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$DistanceToXmlElement(Distance instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('Distance'),
      [
