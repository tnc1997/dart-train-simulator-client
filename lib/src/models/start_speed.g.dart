...
void _$StartSpeedBuildXmlChildren(StartSpeed instance, XmlBuilder builder,
...
void _$StartSpeedBuildXmlElement(StartSpeed instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('StartSpeed', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$StartSpeedToXmlAttributes(StartSpeed instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$StartSpeedToXmlChildren(StartSpeed instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$StartSpeedToXmlElement(StartSpeed instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('StartSpeed'),
      [
