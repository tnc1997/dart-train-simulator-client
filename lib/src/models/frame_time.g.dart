...
void _$FrameTimeBuildXmlChildren(FrameTime instance, XmlBuilder builder,
...
void _$FrameTimeBuildXmlElement(FrameTime instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('FrameTime', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$FrameTimeToXmlAttributes(FrameTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$FrameTimeToXmlChildren(FrameTime instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$FrameTimeToXmlElement(FrameTime instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('FrameTime'),
      [
