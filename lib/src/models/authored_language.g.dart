...
void _$AuthoredLanguageBuildXmlChildren(
    AuthoredLanguage instance, XmlBuilder builder,
...
void _$AuthoredLanguageBuildXmlElement(
    AuthoredLanguage instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('AuthoredLanguage',
...
AuthoredLanguage _$AuthoredLanguageFromXmlElement(XmlElement element) {
  ...
  final type = element.getAttribute('type',
      namespace: 'http://www.kuju.com/TnT/2003/Delta');
  return AuthoredLanguage(text: text, type: type);
}

List<XmlAttribute> _$AuthoredLanguageToXmlAttributes(AuthoredLanguage instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$AuthoredLanguageToXmlChildren(AuthoredLanguage instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$AuthoredLanguageToXmlElement(AuthoredLanguage instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
