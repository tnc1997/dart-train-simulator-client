...
part of 'coal_level.dart';

// **************************************************************************
// XmlSerializableGenerator
// **************************************************************************

void _$CoalLevelBuildXmlChildren(CoalLevel instance, XmlBuilder builder,
...
void _$CoalLevelBuildXmlElement(CoalLevel instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('CoalLevel', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

CoalLevel _$CoalLevelFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$CoalLevelToXmlAttributes(CoalLevel instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$CoalLevelToXmlChildren(CoalLevel instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$CoalLevelToXmlElement(CoalLevel instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('CoalLevel'),
      [
