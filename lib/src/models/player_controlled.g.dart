...
void _$PlayerControlledBuildXmlChildren(
    PlayerControlled instance, XmlBuilder builder,
...
void _$PlayerControlledBuildXmlElement(
    PlayerControlled instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('PlayerControlled',
...
PlayerControlled _$PlayerControlledFromXmlElement(XmlElement element) {
  ...
  final type = element.getAttribute('type',
      namespace: 'http://www.kuju.com/TnT/2003/Delta');
  return PlayerControlled(text: text, type: type);
}

List<XmlAttribute> _$PlayerControlledToXmlAttributes(PlayerControlled instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$PlayerControlledToXmlChildren(PlayerControlled instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$PlayerControlledToXmlElement(PlayerControlled instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
