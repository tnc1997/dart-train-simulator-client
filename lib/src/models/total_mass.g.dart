...
part of 'total_mass.dart';

// **************************************************************************
// XmlSerializableGenerator
// **************************************************************************

void _$TotalMassBuildXmlChildren(TotalMass instance, XmlBuilder builder,
...
void _$TotalMassBuildXmlElement(TotalMass instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('TotalMass', namespaces: namespaces, isSelfClosing: false,
      nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}

TotalMass _$TotalMassFromXmlElement(XmlElement element) {
...
List<XmlAttribute> _$TotalMassToXmlAttributes(TotalMass instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$TotalMassToXmlChildren(TotalMass instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$TotalMassToXmlElement(TotalMass instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('TotalMass'),
      [
