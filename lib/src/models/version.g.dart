...
void _$VersionBuildXmlChildren(Version instance, XmlBuilder builder,
...
void _$VersionBuildXmlElement(Version instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('Version', namespaces: namespaces, isSelfClosing: false,
      nest: () {
...
List<XmlAttribute> _$VersionToXmlAttributes(Version instance,
    {Map<String, String?> namespaces = const {}}) {
...
List<XmlNode> _$VersionToXmlChildren(Version instance,
    {Map<String, String?> namespaces = const {}}) {
...
XmlElement _$VersionToXmlElement(Version instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('Version'),
      [
