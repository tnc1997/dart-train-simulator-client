...
List<XmlAttribute> _$CWagonToXmlAttributes(
  CWagon instance, {
  Map<String, String?> namespaces = const {},
}) {
  final id = instance.id;
...
List<XmlNode> _$CWagonToXmlChildren(
  CWagon instance, {
  Map<String, String?> namespaces = const {},
}) {
  final flipped = instance.flipped;
...
XmlElement _$CWagonToXmlElement(
  CWagon instance, {
  Map<String, String?> namespaces = const {},
}) {
  return XmlElement(
